...
func (r *ClusterAccessReconciler) updateStatus(ctx context.Context, access *vtkiov1alpha1.ClusterAccess) error {
	if r.StatusNeedUpdate {
		...
		if err != nil {
			...
			// r.Log.Error(err, "Cannot Update ClusterAccess object.")
			return err
		}
		// r.Log.Info("Updated ClusterAccess Status.")
...
func (r *ClusterAccessReconciler) setCondition(
...
func (r *ClusterAccessReconciler) removeDuplicateConditions(access *vtkiov1alpha1.ClusterAccess) {
