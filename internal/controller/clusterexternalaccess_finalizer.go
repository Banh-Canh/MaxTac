...
func (r *ClusterExternalAccessReconciler) addFinalizer(ctx context.Context, access *vtkiov1alpha1.ClusterExternalAccess) error {
...
func (r *ClusterExternalAccessReconciler) removeFinalizer(ctx context.Context, access *vtkiov1alpha1.ClusterExternalAccess) error {
	if !access.DeletionTimestamp.IsZero() {
