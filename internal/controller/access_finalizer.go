...
func (r *AccessReconciler) addFinalizer(ctx context.Context, access *vtkiov1alpha1.Access) error {
...
func (r *AccessReconciler) removeFinalizer(ctx context.Context, access *vtkiov1alpha1.Access) error {
	if !access.DeletionTimestamp.IsZero() {
