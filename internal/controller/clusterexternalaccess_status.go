...
func (r *ClusterExternalAccessReconciler) updateStatus(ctx context.Context, access *vtkiov1alpha1.ClusterExternalAccess) error {
	if r.StatusNeedUpdate {
		...
		// Update the ClusterExternalAccess
		...
		if err != nil {
			...
			// r.Log.Error(err, "Cannot Update ClusterExternalAccess object.")
			return err
		}
		// r.Log.Info("Updated ClusterExternalAccess Status.")
...
func (r *ClusterExternalAccessReconciler) setCondition(
...
func (r *ClusterExternalAccessReconciler) removeDuplicateConditions(access *vtkiov1alpha1.ClusterExternalAccess) {
