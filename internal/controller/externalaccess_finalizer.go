...
func (r *ExternalAccessReconciler) addFinalizer(ctx context.Context, access *vtkiov1alpha1.ExternalAccess) error {
...
func (r *ExternalAccessReconciler) removeFinalizer(ctx context.Context, access *vtkiov1alpha1.ExternalAccess) error {
	if !access.DeletionTimestamp.IsZero() {
